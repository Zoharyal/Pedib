...
class DisplayController extends Controller
{
    ...
    {
        return $this->render('infoDisplay/map.html.twig');
    }

    public function mapServiceAction(Request $request) {
      if($request->isXmlHttpRequest()) {
        ...
        $mapInfo = ["AdvertInfo" => $advertInfo , "UserInfo" => $userInfo];
        return new JsonResponse($mapInfo);
      }

      return new Response("Erreur erreur");
    }
